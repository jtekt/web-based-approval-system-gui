...
do
  ...
  sed -i 's|VITE_HELP_URL_PLACEHOLDER|'${VITE_HELP_URL}'|g' $file
  sed -i "s|VITE_APP_TITLE_PLACEHOLDER|$VITE_APP_TITLE|g" "$file"
  ...
  sed -i 's|VITE_ENRICHMENT_ID_PLACEHOLDER|'${VITE_ENRICHMENT_ID}'|g' $file
